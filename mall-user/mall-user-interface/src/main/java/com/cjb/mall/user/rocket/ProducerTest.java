package com.cjb.mall.user.rocket;
...
import java.util.Properties;
    ...
    public class ProducerTest {
        public static void main(String[] args) {
            ...
            properties.put(PropertyKeyConst.AccessKey,"LTAI4FshCfBSKoKLFsigxGLw");
            // SecretKey 阿里云身份验证，在阿里云用户信息管理控制台获取
            properties.put(PropertyKeyConst.SecretKey, "u6LZLeVzR2tYKPXLahHisldtpR1qMF");
            //设置发送超时时间，单位毫秒
